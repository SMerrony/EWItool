...
public class UiOscGrid extends GridPane {
  ...
  UiOscGrid( int ix ) {
    ...
    add( new ControlLabel( "Saw", HPos.CENTER ), 2, 0 );
    add( new ControlLabel( "Tri", HPos.CENTER ), 3, 0 );
    add( new ControlLabel( "Sqr", HPos.CENTER ), 4, 0 );
    
    add( new GroupLabel( "PWM" ), 6, 1 );
    add( new GroupLabel( "Sweep" ), 7, 0 );

    add( new GroupLabel( "Breath" ), 9, 0 );
    add( new ControlLabel( "Vol", HPos.CENTER ), 10, 0 );
    
    add( new ControlLabel( "Octave", HPos.CENTER ), 0, 1 );
    octaveChoice = new ChoiceBox();
    add( octaveChoice, 0, 2 );
    
    add( new ControlLabel( "Fine", HPos.CENTER ), 1, 1 );
    ...
    add( new ControlLabel( "Beat", HPos.CENTER ), 1, 3 );
    ...
    add( new ControlLabel( "Width", HPos.RIGHT ), 5, 2 );
    ...
    add( new ControlLabel( "Freq", HPos.RIGHT ), 5, 3 );
    ...
    add( new ControlLabel( "Depth", HPos.RIGHT ), 5, 4 );
    ...
    add( new ControlLabel( "Time", HPos.CENTER ), 7,1 );
    ...
    add( new ControlLabel( "Depth", HPos.CENTER ), 7, 3 );
    ...
    add( new ControlLabel( "Attain", HPos.CENTER ), 8, 1 );
    ...
    add( new ControlLabel( "Thresh", HPos.CENTER ), 8, 2 );
    ...
    add( new ControlLabel( "Curve", HPos.CENTER ), 8, 3 );
    ...
    add( new ControlLabel( "Depth", HPos.CENTER ), 8, 4 );
